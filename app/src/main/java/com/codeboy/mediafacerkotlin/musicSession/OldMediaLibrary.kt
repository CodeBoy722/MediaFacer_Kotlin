...
@UnstableApi
class OldMediaLibrary : MediaLibraryService(), OnAudioFocusChangeListener, Player.Listener {
        ...
        player =
            ExoPlayer.Builder(this)
                ...
                .also {
                    ...
                    it.addListener(this@OldMediaLibrary)
                    //it.prepare()
                }

        val sessionActivityPendingIntent =
            TaskStackBuilder.create(this).run {
                addNextIntent(Intent(this@OldMediaLibrary, MainActivity::class.java))
 ...
 * background.*/
        ...
        override fun onForegroundServiceStartNotAllowedException() {
            val notificationManagerCompat = NotificationManagerCompat.from(this@OldMediaLibrary)
            ensureNotificationChannel(notificationManagerCompat)
            val pendingIntent =
                TaskStackBuilder.create(this@OldMediaLibrary).run {
                    addNextIntent(Intent(this@OldMediaLibrary, MainActivity::class.java))
            ...
            val builder =
                NotificationCompat.Builder(this@OldMediaLibrary, CHANNEL_ID)
